    ...
    <div class="flex flex-col gap-3 p-4 flex-1">
        <div class="grid grid-cols-2 gap-3">
            ...
            <div>
                ...
                @else
                    <span class="inline-flex items-center justify-center w-full whitespace-nowrap font-medium text-gray-500 dark:text-gray-400 border-none px-4 h-10 text-sm rounded-lg pointer-events-none">
                        {{ __('Disabled') }}
                    </span>
                @endif
            </div>
